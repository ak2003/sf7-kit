...
func SetItemCart(ctx context.Context, itemCart model.AddToCartRequest, res *pModel.ProductDetail, lastTotal int64, currentItems []model.ItemCart) ([]model.ItemCart, int64, error) {
...
func DataOptionsItems(ctx context.Context, itemCart model.AddToCartRequest, res *pModel.ProductDetail, lastTotal int64) ([]model.OptionsItemCart, int64) {
	var (
