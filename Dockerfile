...
#USER nobody
#ENV GO111MODULE=on
#RUN mkdir -p $GOPATH/src/gitlab.dataon.com/gophers/sf7-kit
#WORKDIR $GOPATH/src/github.dataon.com/gophers/sf7-kit
#RUN go mod vendor
#
#COPY . $GOPATH/src/github.dataon.com/gophers/sf7-kit
#RUN go build
#
#CMD ["./sf7-kit"]
